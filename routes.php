...
post('/add-rss','sub-project/view/form.php');
post('/add-broadcast','sub-project/view/form1.php');

post('/single-news/add-stats','sub-project/view/stats.php');
...
get('/broadcast', 'sub-project/view/broadcast.php');
