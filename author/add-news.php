                            ...
                            <div class="block-body">
                                ...
                                <form method="post" enctype="multipart/form-data" id="cnews-add-news">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="form-control-label">Self Reporting IdeoLogical Leaning</label>

                                            <select name="c_news[self_leaning]" class="form-control mb-3 mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <div class="cnews_excerpt_input">
                                                ...
                                                <textarea name="c_news[excerpt]" class="form-control" id="cnews_excerpt" cols="30" rows="5"><?php echo cnews_get_value('excerpt', $posted_news); ?></textarea>
                                                <span id="display_count" class="text-white">0</span><span class="text-white">/200</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button id="check" class="cnews-latest-news-test btn btn-primary"><?php echo $is_edit ? 'Update News' : 'Create News'; ?></button>
                                        <input type="submit" name="cnews-latest-news" value="Create News" id="check" class="cnews-latest-news d-none btn btn-primary">
